        ...
        <div class="col-md-4">
            <form action="" method ="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value ="<?php echo $author_name ?>" name="author_name"> <br>
                  
                </div>
                <button type="submit" name="update_author" class="btn btn-primary">Update Book</button>
            </form>
